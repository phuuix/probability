...
/* interrupt source */
#define INTSRC_WDT        0              /* watchdog interrupt */
#define INTSRC_RESV       1              /* reserved for software interrupts only */
#define INTSRC_ARMCORE0   2              /* ARM core, embedded ICE, DbgCommRx */
#define INTSRC_ARMCORE1   3              /* ARM core, embedded ICE, DbgCommTx */
#define INTSRC_TIMER0     4              /* Timer0, match 0-3 (MR0, MR1, MR2, MR3) */
#define INTSRC_TIMER1     5              
#define INTSRC_UART0      6
#define INTSRC_UART1      7
#define INTSRC_PWM        8
#define INTSRC_I2C        9
#define INTSRC_SPI0       10
#define INTSRC_SPI1       11
#define INTSRC_PLL        12
#define INTSRC_RTC        13
#define INTSRC_EINT0      14
#define INTSRC_EINT1      15

/* PLL & clock */
#define FOSC           11059200       /* in Hz */
#define CCLK           11059200*4
#define PCLK           11059200*2
