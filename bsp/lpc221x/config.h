...
#define TILDE_STACK_SIZE	0x300
/* kservice task's stack size */
#define TKSERV_STACK_SIZE	0x300       // no kservice task
/* kservice task's priority */
#define TKSERV_PRIORITY		0x4
...
#define MEMORY_SIZE64_N     40
#define MEMORY_SIZE256_N    8
#define MEMORY_SIZE768_N    4
#define MEMORY_SIZEBIG_N    2

#define MEMORY_SIZE64       64
#define MEMORY_SIZE256      256
#define MEMORY_SIZE768      768
