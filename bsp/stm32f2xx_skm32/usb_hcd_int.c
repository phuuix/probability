...
#define PUHUIX_BUIKIN 
#ifdef PUHUIX_BUIKIN
//#include "uprintf.h"

uint8_t hc_num_nak[4];
#endif
uint32_t USB_OTG_USBH_handle_hc_n_In_ISR (USB_OTG_CORE_HANDLE *pdev , uint32_t num)
{
  ...
  //uprintf_default("USB_OTG_USBH_handle_hc_n_In_ISR hcchar=0x%x hcint=0x%x\n", hcchar.d32, hcint.d32);
