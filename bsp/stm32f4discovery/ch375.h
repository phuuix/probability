...
/************************************************************************************************************/
#define CH375_STATE_ERROR   0
#define CH375_STATE_NOTCNCT 1        //not connected with device
#define CH375_STATE_NOTENUM 2        // device connected but not finished enum
#define CH375_STATE_WORKING 3        // working properly

//#define CH375_EVENT_MSG 0x80

typedef union ch375_mail_s
{
	uint32_t interrupt;
	struct {
		uint8_t event;
...
#define CH375_MAX_ENDPOINTS 4
#define CH375_TOG_DATA0 0x80
#define CH375_ENDP_DIRECT_IN 0x80
#define CH375_ENDP_DIRECT_OUT 0x0
#define SAMV_HEADER_SIZE 7

typedef struct ch375_s
{
	uint8_t state;
	ch375_endpoint_t endpoint[CH375_MAX_ENDPOINTS]; //0 for in, 1 for out, 2 for second in, 3 for second out
