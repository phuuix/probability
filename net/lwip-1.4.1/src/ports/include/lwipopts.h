...
/* simulate mutex by semaphore, for simple */
...
/* overwriten for tcpip thread macros */
#define TCPIP_THREAD_PRIO       0x03
...
*/
//puhuix: this macro will cause checksum of ICMP to 0!! comment it for work around
...
*/
#define LWIP_DEBUG                      1
#define NETIF_DEBUG                     0x80  // 0x80: enable debug
#define ETHARP_DEBUG                    0x80
#define ICMP_DEBUG                      0x80
